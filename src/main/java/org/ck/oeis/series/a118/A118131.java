package org.ck.oeis.series.a118;
...
class A118131 extends Series {
  private static final BigInteger[] values =
      ResourceScanner.resourceAsBigIntegerArray(A118131.class.getResourceAsStream("A118131"));

  public A118131() {
    super("Profile of a woman, after Jean-Pierre David.");
  }
